...
import { BigFishOssUploader } from 'aragorn-uploader-bigfish';
...
const bigfish = new BigFishOssUploader();
...
export class AragornCore {
  ...
  constructor() {
    this.uploaders = [bigfish, alioss, tencentcos, qiniu, ucloud, upyun, github, gitee, custom];
  }
