// import { BASE_URL } from 'upload-types/dist/commonjs/index';
const BASE_URL = '';
// 升级信息
export const ClientUpdateInfo = [
  {
    html_url: 'https://www.mgtv.com/',
    version: '1.0.0',
    size: 78983183,
    uploader: [],
    description: `第一版本:`,
...
export const ClientSetting = [
  {
    key: 'GithubReleaseApi',
    label: '更新地址',
    type: 'el-input',
    defaultValue: `${BASE_URL}api/update/client/releases`,
    disabled: true,
    options: [],
  },
  {
    ...
    label: '菜单地址',
    type: 'el-input',
    defaultValue: `${BASE_URL}api/auth/menus`,
    disabled: true,
    options: [],
  },
  {
